...
const CreateConsultation =  (props) =>{
    ...
    const [typeoff, setTypeoff] = useState('Laser Dentists');
    ...
    const submithandle = () =>{
        if(name!=="" && mobileNumber!=="" && cc!=="" && typeoff!=="" && experience!=="" && pincode!=="" && lat!=="" && lng!=="" && description!==""){
            ...
            var config = {  
              ...
              url: API_URL + '/admin/consultation/create',
              data: data
            };
...
:null}
               ...
               <Typography component="h1" variant="h5" className={classes.Typography}>
                ...
                <Row>
                <Col>
                <TextField style={{borderWidth:1, borderColor:"red"}} id="outlined-basic" name="name" label="Name" value={name} variant="outlined" onChange={(e)=>setName(e.target.value)} className={classes.TextField} />
                {name==="" ?
                <p style={{color:"red", fontWeight:"bold", marginLeft:10, marginTop:-8}}>{requiredfields}</p>
                :null}
                </Col>
                <Col>
                <TextField type="number" id="outlined-basic" name="mobileNumber" label="Mobile Number" value={mobileNumber} variant="outlined" onChange={(e)=>setMobileNumber(e.target.value)} className={classes.TextField} />
                {mobileNumber==="" ?
                <p style={{color:"red", fontWeight:"bold", marginLeft:10, marginTop:-8}}>{requiredfields}</p>
                :null}
                </Col>
                <Col>
                <TextField type="number" id="outlined-basic" name="cc" label="CC" value={cc} variant="outlined" onChange={(e)=>setcc(e.target.value)} className={classes.TextField} />
                {cc==="" ?
                <p style={{color:"red", fontWeight:"bold", marginLeft:10, marginTop:-8}}>{requiredfields}</p>
                :null}
                </Col>
...
{typeoff==="" ?
                ...
                <Col>
                <TextField type="number" id="outlined-basic" name="pincode" label="PinCode" value={pincode} variant="outlined" onChange={(e)=>setPincode(e.target.value)} className={classes.TextField} />
                {pincode==="" ?
                <p style={{color:"red", fontWeight:"bold", marginLeft:10, marginTop:-8}}>{requiredfields}</p>
                :null}
                </Col>
                ...
                <Col>
                    <TextField type="number" id="outlined-basic" name="lat" label="Latitude" value={lat} variant="outlined" onChange={(e)=>setLat(e.target.value)} className={classes.TextField} />
                    {lat==="" ?
                <p style={{color:"red", fontWeight:"bold", marginLeft:10, marginTop:-8}}>{requiredfields}</p>
                :null}
                </Col>
                <Col>
                <TextField type="number" id="outlined-basic" name="lng" label="Longitude" value={lng} variant="outlined" onChange={(e)=>setLng(e.target.value)} className={classes.TextField} />
                {lng==="" ?
                <p style={{color:"red", fontWeight:"bold", marginLeft:10, marginTop:-8}}>{requiredfields}</p>
                :null}
                </Col>
...
export default withStyles(useStyles)(CreateConsultation);