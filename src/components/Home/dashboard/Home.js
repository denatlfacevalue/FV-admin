      ...
      <div className={classes.root}>
        ...
        <main className={classes.content}>  
          ...
          <Container maxWidth="lg" className={classes.container}>
            ...
            {this.state.getBoardDisplaynumber === 3 &&
...
{this.state.getBoardDisplaynumber === 5 &&
...
// </Paper>
 ...
 {this.state.getBoardDisplaynumber ===  20 &&
...
// </Paper>
            ...
            {this.state.getBoardDisplaynumber === 13 &&
            ...
            {this.state.getBoardDisplaynumber === 18 &&
...
{this.state.getBoardDisplaynumber === 21 &&
